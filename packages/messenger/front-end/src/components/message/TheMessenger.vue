            ...
            <v-card-text class="flex-grow-1 d-flex flex-column">
                ...
                <div class="d-flex flex-column mb-2 mx-2">
                    ...
                    <template v-if="isTransmitting">
                        ...
                        >
                            <span class="mx-2">{{progress}}% ({{ `${transmitProgress.sentBytes} of ${transmitProgress.totalBytes}`}})</span>
                            <span>{{transmitProgress.remainingSeconds.toFixed(2)}} sec left</span>
                        </div>
                        <v-progress-linear
                                class="mb-2"
                                height="8"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            progress() {
                let percentage = this.transmitProgress.sentBytes / this.transmitProgress.totalBytes * 100;
